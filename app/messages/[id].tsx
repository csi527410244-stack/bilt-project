...
import { Ban, Flag, Send, ShieldAlert, Plus, Zap } from 'lucide-react-native';
      ...
      <View className="border-border bg-surface border-b px-4 py-3">
        ...
        {conversation.product ? (
          ...
          >
            ...
            {/* ⚡立即購買 按鈕 */}
            <Pressable
              className="bg-brand-blue h-8 flex-row items-center gap-1 rounded-full px-3"
              onPress={() => {
                // 提示用戶 ECPay 支付的免責聲明
                router.push({
                  pathname: '/checkout',
            ...
            >
              <Zap size={12} color={BRAND.white} />
              <Typography type="body-xs" className="text-white" style={{ fontWeight: '600' }}>
                立即購買
              </Typography>
            </Pressable>
          </Pressable>
          ...
          <>
            ...
            <View className="flex-row items-center gap-2">
              ...
              <Pressable
                ...
                accessibilityLabel="上傳照片"
              >
                <Plus size={18} color={BRAND.navy} />
              </Pressable>
