      ...
      <View className="flex-1 items-center justify-center bg-black/50">
        ...
        >
          ...
          <View className="mb-4 flex-row items-center gap-3">
            ...
            <Typography type="h6" className="text-navy flex-1" style={{ fontWeight: '700' }}>
              交易款項說明
            </Typography>
          </View>

          {/* 免責聲明內容 */}
          <ScrollView scrollEnabled className="mb-6" contentContainerClassName="gap-3">
            ...
            <View className="rounded-lg px-3 py-2" style={{ backgroundColor: BRAND.orangeSoft }}>
              <Typography type="body-xs" className="text-orange-900" style={{ fontWeight: '500' }}>
